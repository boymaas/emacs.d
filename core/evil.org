...
(defvar bmaas/evil-emacs-state-modes '(magit-key-mode))
(defvar bmaas/evil-motion-state-modes '(dired-mode))
...
(eval-after-load 'evil
  '(progn
     ...
     (append evil-motion-state-modes bmaas/evil-motion-state-modes)
...
(eval-after-load 'magit
  '(progn
     ...
     (add-hook )
     (dolist (a-magit-mode-map  (list magit-mode-map))
             (evil-make-overriding-map a-magit-mode-map 'motion))))
#+end_src
